...
class Vocab(object):
    ...
    def filter_tokens_by_cnt(self, min_cnt):
        ...
        self.token2id = {}
        self.id2token = {}
        # since we dont need the count of each token, we dont have to update the count, set cnt=0
        for token in self.initial_tokens:
    ...
    def randomly_init_embeddings(self, embed_dim):
        ...
        """
        # randomly initialize the embeddings, especially, the pad_token and unk_token is initialized to zeros
